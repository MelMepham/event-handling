...
three.addEventListener('mouseenter', makePink)
...
function makeBlue (evt) {
  evt.target.style.backgroundColor = '#539BFC'
}
...
function makePink (evt) {
  evt.target.style.backgroundColor = '#FA45DA'
}

function makeYellow (evt) {
  evt.target.style.backgroundColor = "#FFF450"
}
